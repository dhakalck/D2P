...
```
data-to-policy/
├── index.html (renamed from d2p-index.html)
├── about.html (renamed from d2p-about.html)
├── styles.css (renamed from d2p-styles.css)
├── images/
│   └── D2P.jpg
│
├── training/
...
## 🌐 Integration with Other D2P Websites
...
© 2026 Data for Health Initiative | Bloomberg Philanthropies
